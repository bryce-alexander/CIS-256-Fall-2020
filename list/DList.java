...
public class DList {
    ...
    public void insertFront(Object item) {
        // Your solution here.
        head.next = newNode(item, head, head.prev);
    ...
    public void insertBack(Object item) {
        // Your solution here.
        DListNode temp = newNode(item, null, null);
        temp.next = head;
        head.prev.next = temp;
        temp.prev = head.prev;
        head.prev = temp;
    ...
    public DListNode next(DListNode node) {
        // Your solution here.
        if(node.next == node.prev || node == null) {
            return null;
        }else {
            return node.next;
        }
    ...
    public DListNode prev(DListNode node) {
        // Your solution here.
        if(node.prev == node.next || node == null) {
            return null;
        }else {
            return node.prev;
        }
    ...
    public void insertAfter(Object item, DListNode node) {
        // Your solution here.
        if(node == null) { return; }
        DListNode insertAft = newNode(item, node, node.next);
        node.next.prev = node;
        node.next = insertAft;
        size++;
    ...
    public void insertBefore(Object item, DListNode node) {
        // Your solution here.
        if(node == null) { return; }
        DListNode insertBe4 = newNode(item, node.prev, node);
        node.prev.next = insertBe4;
        node.prev = insertBe4;
        size++;
    }

    /**
     * remove() return node removed from this DList. If node is null, do nothing.
     * Performance: runs in O(1) time.
     *
     * @return node the node removed from DList if it in not empty, or null if empty.
    ...
    /**
     * isSentinelNextNull() returns true if sentinel head.next is null, false otherwise.
     *
     * @return true if sentinel head.next is empty, false otherwise. Performance: runs in
     *         O(1) time.
     */
    private boolean isSentinelNextNull() {
        return head.next == null;
    }

    /**
     * isSentinelPrevNull() returns true if sentinel head.prev is null, false otherwise.
     *
     * @return true if sentinel head.prev is empty, false otherwise. Performance: runs in
     *         O(1) time.
     */
    private boolean isSentinelPrevNull() {
    ...
    /**
     * Displays the DList's contents, size, whether it's empty, whether its head.next is
     * null, and whether its head.prev is null.
     * */
    public void displayLinkedList(DList list) {
        System.out.println("The List contents are:");
        System.out.println(list);
        System.out.println("The list size is " + list.size + ".");
        System.out.println("Is the list empty? " + list.isEmpty());
        System.out.println("Is head.next null? " + list.isSentinelNextNull());
        System.out.println("Is head.prev null? " + list.isSentinelPrevNull() + "\n");
    }
