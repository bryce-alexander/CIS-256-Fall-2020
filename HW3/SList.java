...
public class SList {
    ...
    public void squish() {
		...
		/*SListNode nextPos = head.next;

		while(cur.next != null) {

			if(cur.item.equals(nextPos.next.item)) {
				cur = nextPos.next;
			}
			else {
				cur = nextPos;
     ...
     * 4 4 2 2 2 2 ].
     *
     * IMPORTANT: Do not try to make new copies of the items themselves. Make new
     * SListNodes, but just copy the references to the items.
     **/
