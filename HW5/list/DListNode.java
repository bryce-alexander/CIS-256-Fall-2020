...
public class DListNode extends ListNode {
	...
	public void insertAfter(Object item) throws InvalidNodeException {
		...
		// new node.
			...
			DListNode insertAft = (((DList) myList).newNode(item, ((DList)myList), this, this.next));
			this.next.prev = insertAft;
			this.next = insertAft;
			this.myList.size++;
		}
	}
	...
	public void insertBefore(Object item) throws InvalidNodeException {
		...
		// new node.
			...
			DListNode insertBefore = ((DList)myList).newNode(item, ((DList) myList), this.prev, this);
			this.prev.next = insertBefore;
			this.prev = insertBefore;
			this.myList.size++;
		}
	}
