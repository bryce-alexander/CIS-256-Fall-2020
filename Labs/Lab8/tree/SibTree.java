...
public class SibTree extends Tree {
  ...
  public SibTree(Object item) {
    root = new tree.SibTreeNode(this, item);
    size = 1;
  }
  ...
  public void insertRoot(Object item) {
    tree.SibTreeNode newRoot = new tree.SibTreeNode(this, item);
  ...
  private String preorderString(tree.SibTreeNode currentNode, int depth) {
    if (currentNode == null) {
      return "";
    }
    String s = "";
