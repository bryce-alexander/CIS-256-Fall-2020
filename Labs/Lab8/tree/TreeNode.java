...
public abstract class TreeNode {
   ...
   *  Performance:  runs in O(1) time.
   */
  public Object item() throws tree.InvalidNodeException {
    if (isValidNode()) {
      return item;
    } else {
   ...
   *  Performance:  runs in O(1) time.
   */
  public void setItem(Object item) throws tree.InvalidNodeException {
    if (isValidNode()) {
      this.item = item;
    } else {
      throw new tree.InvalidNodeException();
   ...
   */
  public abstract TreeNode parent() throws tree.InvalidNodeException;
   ...
   *  cth child.
   */
  public abstract TreeNode child(int c) throws tree.InvalidNodeException;
   ...
   */
  public abstract TreeNode nextSibling() throws tree.InvalidNodeException;
   ...
   */
  public abstract void removeLeaf() throws tree.InvalidNodeException;
