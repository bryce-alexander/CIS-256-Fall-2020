...
public class WUGraph {
    ...
    private HashTableChained vertexNodes;
    ...
    public WUGraph() {
        ...
        vertexNodes = new HashTableChained();
    }
    ...
    public void addVertex(Object vertex) {  // Creates new DList to store edges as value for hashtable entry
        if (vertices.find(vertex)==null) {
            ...
            DListNode vertexNode = vertexList.insertBack(vertex);
            vertexCount++;
            vertexNodes.insert(vertex, vertexNode);
        }
    }
    ...
    public void removeVertex(Object vertex) {
        if (vertices.find(vertex) != null) {
            ...
            DListNode vertexNode = (DListNode)vertexNodes.find(vertex).value();
     ...
     * <p>
     * Running time:  O(1).
     * @params u,v represent a vertex object in a specific edge
     * @param weight represents the weight of this edge
     */
        ...
        if (vertices.find(u) != null && vertices.find(v) != null) {
            ...
            if (edges.find(edge) != null) {
                ...
                if (!edge.object1.equals(edge.object2)) {                   // If objects are equal, don't add the edge twice to the adjacency list
                    edge.object2Node = edge.object2List.insertFront(edge);
                }
     ...
     * Running time:  O(1).
     * @params u,v represent a vertex object in a specific edge
     * @return true/false indicating whether this pair matches an existing edge
     */
