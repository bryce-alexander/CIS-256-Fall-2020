...
public class VertexPair {
  ...
  /**
   * otherObject() takes a vertex as input and returns the other vertex.
   * If the current VertexPair contains two of the same object, it will return
   * the same object supplied.
