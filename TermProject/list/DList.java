...
public class DList {
  ...
  protected TermProject.list.DListNode head;
  protected int size;
   ...
   */
  protected TermProject.list.DListNode newNode(Object item, TermProject.list.DListNode prev, TermProject.list.DListNode next) {
    return new TermProject.list.DListNode(item, prev, next);
  }
  ...
  /**
   *  insertFront() inserts an item at the front of this DList. /////////////////////////////////////////////////CHANGE THIS DESCRIPTION //////////////////////////////////////////////////////////
   *  @param item is the item to be inserted.
   *  Performance:  runs in O(1) time.
   */
  public DListNode insertFront(Object item) { //////////////////////////////////////// Changed return from void
    // Your solution here.
    TermProject.list.DListNode insertNode = newNode(item, head, head.next);
   ...
   *  Performance:  runs in O(1) time.
   */
  public TermProject.list.DListNode front() {
    // Your solution here.
   ...
   *  Performance:  runs in O(1) time.
   */
  public TermProject.list.DListNode back() {
    // Your solution here.
    if (isEmpty()) { return null;}
   ...
   *  Performance:  runs in O(1) time.
   */
  public TermProject.list.DListNode next(TermProject.list.DListNode node) {
    // Your solution here.
   ...
   *  Performance:  runs in O(1) time.
   */
  public TermProject.list.DListNode prev(TermProject.list.DListNode node) {
    // Your solution here.
   ...
   *  Performance:  runs in O(1) time.
   */
  public void insertAfter(Object item, TermProject.list.DListNode node) {
    // Your solution here.
    if (node==null) { return; }
    TermProject.list.DListNode insertNode = newNode(item, node, node.next);
   ...
   *  Performance:  runs in O(1) time.
   */
  public void insertBefore(Object item, TermProject.list.DListNode node) {
    // Your solution here.
    if (node==null) { return; }
    TermProject.list.DListNode insertNode = newNode(item, node.prev, node);
   ...
   *  Performance:  runs in O(1) time.
   */
  public void remove(TermProject.list.DListNode node) {
    // Your solution here.
    if (node==null) { return; }
  ...
  public String toString() {
    String result = "[  ";
    TermProject.list.DListNode current = head.next;
